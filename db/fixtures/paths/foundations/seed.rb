...
course.add_section do |section|
  ...
  section.description = 'This section will introduce you to the world of web development and The Grassroot Project.'
  ...
  section.add_lessons(
    ...
    foundation_lessons.fetch('Join the Grassroot Community'),
  )
end
