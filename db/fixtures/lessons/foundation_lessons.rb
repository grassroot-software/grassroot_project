def foundation_lessons
  {
    ...
    'Join the Grassroot Community' => {
      title: 'Join the Grassroot Community',
      description: "Find out how to join Grassroot's community of new and veteran learners and how to get help with coding problems.",
      is_project: false,
