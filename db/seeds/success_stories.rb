success_stories = [
  ...
  },
  {
    ...
    story_content: "<p>Before I found Grassroot, I was jumping from course to course without really any guidance or community. I wanted to get a real development job and not operating an IT help desk, and I wanted to do it for free.</p> <p>After reading people's success stories on Reddit on how they found a development job, many people praised the curriculum at Grassroot and how they got a job even before they finished it. I couldn’t believe it! So I decided to give it a shot.</p> <p>The self-paced structure, reading materials, and challenges was easy to understand and made me feel I was in control. I was even able to find a community to help guide and mentor me through the process. About eight months after I started, I got my first development gig - and I didn't even finish the curriculum! Because of Grassroot, I can call myself a developer.</p>",
  ...
  },
  {
    ...
    story_content: '<p>Before I started The Grassroot Project I had literally ZERO programming experience. After almost exactly a year of working through the program, I was offered a job as a front end web developer.</p> <p>Grassroot taught me all the most crucial skills in webdev and gave me an incredibly strong foundation for branching out and learning other pieces of the web-dev puzzle along the way.</p>',
  ...
  },
  {
    ...
    story_content: '<p>The Grassroot Project changed my life and that is not an understatement. In November 2013, I made a commitment to myself to become a self-taught developer so I threw myself head first into Google trying to learn everything I could.</p> <p>Originally, I wanted to be a Java Web Developer then a week later I wanted to be an Android developer. I was reading blog post after blog post, and pretty soon I started to get overwhelmed. I had no structure and no plan of attack about how to get a development job.</p> <p>I was desperate to change career and then suddenly I stumbled across The Grassroot Project, and it had exactly what I needed. An exact path to take to become a Software Developer. It was like taking a college course except it was free and in my own time.</p> <p>I started going through the course, and by June 2015 I got my first development job. Exactly 14 months after I started The Grassroot Project. I never had to quit my job, and I always had something to look forward to in the evening.</p>',
    job_title: 'Software Engineer',
    social_media_link: '#'
  },
  {
    student_name: 'Jackson Andrej',
    avatar_path_name: 'andrej_dragojevic.jpg',
    story_content: '<p>An incredible self-paced curriculum that consists of the best resources for learning programming on the web! It was an invaluable resource on my path to a becoming a software developer.</p> <p>Thanks to The Grassroot Project I was able to get a job half way through the curriculum, and the projects completed as part of the curriculum gave me an edge compared to other junior developers with no experience.</p>',
    job_title: 'Full Stack Ruby on Rails Developer',
    social_media_link: '#'
  },
  {
    student_name: 'Gibson Yapo',
    avatar_path_name: 'skip.jpg',
    story_content: "<p>Before I found The Grassroot Project I had very little direction with my learning, jumping from topic to topic then trying to piece things together as I went.</p> <p>Having this online curriculum to follow was a massive help and took my understanding of programming to the next level. Being self taught and going into a job interview with no professional experience is incredibly daunting, but being able to point to my GitHub which had all of the projects I'd completed while going through the curriculum, I was able to demonstrate that I was committed to learning and improving myself, ultimately that's exactly what they were after in an employee.</p> <p>If you're considering using The Grassroot Project I really cannot recommend it enough, I owe my career to this site.</p>",
  ...
  {
    student_name: 'Neas Alban',
    avatar_path_name: 'sean.jpg',
    story_content: '<p>Grassroot smoothed out the steep learning curve in web development, allowing me to confidently learn at my own pace and taught me how to approach and solve real-life programming problems.</p> <p>The projects in Grassroot were a perfect mix of difficulty, allowing me to gain exposure to different technologies and feel challenged without feeling overwhelmed. Because of the foundation Grassroot provided, I was able to easily transition into freelancing and then into a junior level Rails developer position.</p>',
